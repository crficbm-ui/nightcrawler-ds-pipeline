...
class ZyteExtractor(DataCollector):
    ...
    def retrieve_response(self, client: ZyteAPI, urls: List[str], api_config: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def structure_results(self, responses: List[Dict[str, Any]]) -> List[Dict[str, str]]:
        """
    ...
    def store_results(self, structured_results: List[Dict[str, str]]) -> None:
        """
        ...
        """
        write_json(self.context.output_path, self.context.zyte_filename, structured_results)

    def apply(self, urls: List[str]) -> List[Dict[str, str]]:
        """
