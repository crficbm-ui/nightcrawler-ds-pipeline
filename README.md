...
| `-n max_number_of_results, --number-of-results max_number_of_results` | Option    | `fullrun`                       | Set the maximum number of results from Serpapi (default: 0 -> return all., max: 3 per Google Shopping, Google Site Search, Google, and eBay) |
